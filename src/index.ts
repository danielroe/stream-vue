import type { ComponentObjectPropsOptions, DefineComponent } from 'vue'
...
interface VideoStreamProps {
  /**
   * Either the video id of the video you’ve uploaded to Cloudflare Stream, or the signed URL representing the video.
   */
  src?: string
  /**
   * Tells the browser to immediately start downloading the video and play it as soon as it can.
   * @default false
   */
  autoplay?: boolean
  /**
   * Shows the default video controls.
   * @default false
   */
  controls?: boolean
  /**
  ...
  width?: string | number
  /**
   * Whether the audio is initially silenced.
   * @default false
   */
  muted?: boolean
  /**
   * Whether the player seeks back to the start on completion.
   * @default false
   */
  loop?: boolean
  /** Hint to the browser about preloading. */
...
const videoStreamProps: ComponentObjectPropsOptions<VideoStreamProps> = {
  /**
   * Either the video id of the video you’ve uploaded to Cloudflare Stream, or the signed URL representing the video.
   */
  src: { type: String },
...
export const VideoStream: DefineComponent<VideoStreamProps> = defineComponent({
  name: 'VideoStream',
